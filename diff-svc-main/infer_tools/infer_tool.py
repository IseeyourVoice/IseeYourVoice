...
class Svc:
    ...
    def infer(self, in_path, key, acc, use_pe=True, use_crepe=False, thre=0.05, singer=False, **kwargs):
    ...
    def temporary_dict2processed_input(self, item_name, temp_dict, use_crepe=False, thre=0.05):
        '''
    ...
    def pre(self, wav_fn, accelerate, use_crepe=False, thre=0.05):
