...
class PageElement(object):
    ...
    def find_next(self, name=None, attrs={}, string=None, **kwargs):
        ...
        All find_* methods take a user set of arguments. See the online
    ...
    def find_next_sibling(self, name=None, attrs={}, string=None, **kwargs):
        ...
        All find_* methods take a user set of arguments. See the
...
class SoupStrainer(object):
    ...
    def search_tag(self, markup_name=None, markup_attrs={}):
        ...
        if isinstance(self.name, str):
            # Optimization for a very user case where the user is
...
class ResultSet(list):
    ...
    def __getattr__(self, key):
        """Raise a helpful exception to explain a user code fix."""
        raise AttributeError(
